...
coords = [399327 7533900];              % location (UTM)
timeseries_start = '15-Sep-2002 00:00'; % start date
timeseries_end = '15-May-2003 00:00';   % start time
var = 'climT';                       % plot variable (choose from list 
                                       % 	in io.varsout)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%outdir = 'D:\OUTPUT_APRIL_WITH_2'; 
