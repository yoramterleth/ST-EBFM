...
if t==1
    ...
    OUTFILE.varsout(end+1,:) = {'wind_drift'    ;'m w.e.'   ;'sum'      ;'Snow accumulation from wind drift'};
    OUTFILE.varsout(end+1,:) = {'avy_dep'       ;'m w.e.'   ;'sum'      ;'Mass gained from avalanches'};
    OUTFILE.varsout(end+1,:) = {'cmb_classic'   ;'m w.e.'   ; 'sum'     ;'Classic Climatic mass balance'}; 
    OUTFILE.varsout(end+1,:) = {'delta_T'       ;'K'        ; 'mean'    ; 'Avalanche frictional heating'}; 
    OUTFILE.varsout(end+1,:) = {'vm'            ; 'degrees';  'sample'  ; 'Wind direction'};
